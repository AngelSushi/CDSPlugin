...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public Cuboid(World world, Location minLoc, Location maxLoc) {
        this.worldName = world.getName();
        this.x1 = Math.min((int)minLoc.getX(),(int) maxLoc.getX());
        this.x2 = Math.max((int)minLoc.getX(),(int) maxLoc.getX());
        this.y1 = Math.min((int)minLoc.getY(),(int) maxLoc.getY());
        this.y2 = Math.max((int)minLoc.getY(),(int) maxLoc.getY());
        this.z1 = Math.min((int)minLoc.getZ(),(int) maxLoc.getZ());
        this.z2 = Math.max((int)minLoc.getZ(),(int) maxLoc.getZ());
    }
